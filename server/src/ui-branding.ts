...
const DEFAULT_FAVICON_LINKS = [
  '<link rel="icon" href="/favicon.ico?v=agent-delivery-1" sizes="48x48" />',
  '<link rel="icon" href="/favicon.svg?v=agent-delivery-1" type="image/svg+xml" />',
  '<link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.png?v=agent-delivery-1" />',
  '<link rel="icon" type="image/png" sizes="16x16" href="/favicon-16x16.png?v=agent-delivery-1" />',
].join("\n");
