...
import { companySecretBindings } from "@penclipai/db";
import type { EnvSecretRefBinding, SecretProjectionClass, SecretVersionSelector } from "@penclipai/shared";
import { envBindingSecretRefSchema } from "@penclipai/shared";
import {
