...
import type { Agent, Approval, CompanySkill, PermissionKey, Routine, RoutineTrigger, RoutineVariable } from "@penclipai/shared";
...
const REFLECTION_COACH_SKILL = readBuiltInTextWithFallback(
  ...
  [
    ...
    path.resolve(
      moduleDir,
      "../skills-catalog/catalog/bundled/paperclip-operations/reflection-coach/SKILL.md",
    ),
    ...(skillsCatalogRoot
