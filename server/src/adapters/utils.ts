...
import * as serverUtils from "@penclipai/adapter-utils/server-utils";
export type { RunProcessResult } from "@penclipai/adapter-utils/server-utils";
...
export function buildInvocationEnvForLogs(
  ...
  // TODO: Remove this fallback once @penclipai/adapter-utils exports buildInvocationEnvForLogs everywhere we consume it.
...
import type { RunProcessResult } from "@penclipai/adapter-utils/server-utils";
