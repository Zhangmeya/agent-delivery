...
import type { PluginPerformActionActorContext, ToolRunContext } from "@penclipai/plugin-sdk";
import { JsonRpcCallError, PLUGIN_RPC_ERROR_CODES } from "@penclipai/plugin-sdk";
import {
  assertAuthenticated,
  assertBoard,
