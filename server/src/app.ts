...
import { issueDeliverableRoutes } from "./routes/issue-deliverables.js";
...
import { createHostClientHandlers } from "@penclipai/plugin-sdk";
...
export async function createApp(
  ...
  api.use(issueDeliverableRoutes(db));
