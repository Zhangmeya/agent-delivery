...
import type { AdapterExecutionContext, AdapterRuntimeMcpServer } from "@penclipai/adapter-utils";
import {
  runAdapterExecutionTargetShellCommand,
  type AdapterExecutionTarget,
  type AdapterExecutionTargetShellOptions,
} from "@penclipai/adapter-utils/execution-target";
import { resolvePaperclipInstanceRootForAdapter } from "@penclipai/adapter-utils/server-utils";
