...
vi.mock("@penclipai/adapter-utils/server-utils", async () => {
  const actual = await vi.importActual<typeof import("@penclipai/adapter-utils/server-utils")>(
    "@penclipai/adapter-utils/server-utils",
  );
  return {
    ...actual,
    ensureCommandResolvable,
...
vi.mock("@penclipai/adapter-utils/ssh", async () => {
  const actual = await vi.importActual<typeof import("@penclipai/adapter-utils/ssh")>(
    "@penclipai/adapter-utils/ssh",
  );
  return {
    ...actual,
    prepareWorkspaceForSshExecution,
...
vi.mock("@penclipai/adapter-utils/execution-target", async () => {
  const actual = await vi.importActual<typeof import("@penclipai/adapter-utils/execution-target")>(
    "@penclipai/adapter-utils/execution-target",
  );
  return {
    ...actual,
    startAdapterExecutionTargetPaperclipBridge,
