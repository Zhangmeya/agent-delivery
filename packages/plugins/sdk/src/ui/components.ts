 ...
 *
 * These components are exported from `@penclipai/plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@penclipai/plugin-sdk/ui`
 */
 ...
 * @example
 * ```tsx
 * import { FileTree, type FileTreeNode } from "@penclipai/plugin-sdk/ui";
 *
