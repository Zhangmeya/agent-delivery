...
- Content-only updates (new bundled or optional teams, copy edits, skill requirement tweaks) can land directly in this package after `pnpm --filter @penclipai/teams-catalog validate` and `pnpm --filter @penclipai/teams-catalog test` both pass.
