...
|---|---|---|
| **The catalog** | A curated, read-only set of skills that ships with Paperclip | The `@penclipai/skills-catalog` package |
...
The catalog is its own publishable package, `@penclipai/skills-catalog`:
