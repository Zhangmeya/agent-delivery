    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <div className="text-sm font-semibold text-foreground">
          {t("apps.browse.connectOwnTool", { defaultValue: "Connect your own tool" })}
        </div>
        <div className="text-xs text-muted-foreground">
          {t("apps.browse.connectOwnToolDescription", {
...
export function AdvancedToolsLink() {
  ...
  return (
    ...
    >
      ...
      {t("apps.browse.developerTools", { defaultValue: "Developer tools (advanced)" })}
    </Link>
  );
}
