...
function CommandDialog({
  ...
  const resolvedTitle = title ?? t("Command Palette", { defaultValue: "Command Palette" })
  const resolvedDescription =
    description ?? t("Search for a command to run...", { defaultValue: "Search for a command to run..." })
