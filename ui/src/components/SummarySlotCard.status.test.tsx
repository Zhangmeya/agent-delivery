...
} from "./SummarySlotCard";

(
  globalThis as typeof globalThis & { IS_REACT_ACT_ENVIRONMENT?: boolean }
).IS_REACT_ACT_ENVIRONMENT = true;

const { LiveEventSubscriptionContext, dispatchLiveEventToSubscribers } =
...
describe("resolveGenerationStatusLine", () => {
  ...
  it("falls back to the assistant snippet, then the tool name", () => {
    ...
    expect(
      resolveGenerationStatusLine(
        { message: null, currentToolName: "Grep", lastAssistantSnippet: null },
        "Working with Grep",
      ),
...
describe("SummarySlotCard live status line", () => {
  ...
  it("renders a live status line from a matching progress event", async () => {
    ...
    expect(
      container.querySelector('[data-testid="summary-generation-status-line"]'),
    ).toBeNull();
