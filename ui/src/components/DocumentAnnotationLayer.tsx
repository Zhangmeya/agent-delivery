        ...
        <div ref={overlayRef} className="relative h-full w-full">
          {highlightRects.map((rect, index) => {
            ...
            return (
              <button
                ...
                data-status={rect.status}
                data-focused={isFocused || undefined}
                aria-label={t("documentAnnotations.openThread", { defaultValue: "Open annotation thread" })}
                className={cn(
          ...
          {highlightRects.map((rect, index) =>
            rect.isTail && rect.anchorState === "stale" ? (
              <span
                ...
                title={t("documentAnnotations.anchorMovedNeedsReview", { defaultValue: "Anchor moved - needs review" })}
              >
          ...
          {pendingAnchor && toolbarPosition ? (
            <div
              ...
              role="toolbar"
              aria-label={t("documentAnnotations.selectionActions", { defaultValue: "Selection actions" })}
            ...
            >
              <Button
                ...
                title={newCommentDisabled
                  ...
                  : t("documentAnnotations.addCommentOnSelectionShortcut", { defaultValue: "Add comment on selection (⌘⇧M)" })}
              >
