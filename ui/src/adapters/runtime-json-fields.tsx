...
export function RuntimeServicesJsonField({
  ...
  return (
    <Field
      label={t("agentConfig.runtimeServicesJson", {
        defaultValue: "Runtime services JSON",
      })}
      hint={help.runtimeServicesJson}
    >
      <textarea
...
export function PayloadTemplateJsonField({
  ...
  return (
    <Field
      label={t("agentConfig.payloadTemplateJson", {
        defaultValue: "Payload template JSON",
      })}
      hint={help.payloadTemplateJson}
    >
      <textarea
